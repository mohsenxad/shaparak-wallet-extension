console.log("SEPEHR PAYMENT GATEWAY ON SHAPARAK");

function getPAN0Element()
    {
        let PAN0Element = document.getElementById("card1");
        return PAN0Element;
    }

function getPAN1Element()
    {
        let PAN1Element = document.getElementById("card2");
        return PAN1Element;
    }

function getPAN2Element()
    {
        let PAN2Element = document.getElementById("card3");
        return PAN2Element;
    }

function getPAN3Element()
    {
        let PAN3Element = document.getElementById("card4");
        return PAN3Element;
    }

function getCVVElement()
    {
        let CVVElement = document.getElementById("cvv2Input");
        return CVVElement;
    }

function getExpDateMonthElement()
    {
        let ExpDateMonthElement = document.getElementById("monthInput");
        return ExpDateMonthElement;
    }

function getExpDateYearElement()
    {
        let ExpDateYearElement = document.getElementById("yearInput");
